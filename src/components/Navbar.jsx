      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-10">
            <a href="#story" className="text-xs font-medium text-white hover:text-red-500 transition-colors uppercase tracking-widest">The Legend</a>
            ...
            <Link to="/#journal" className="text-xs font-medium text-stone-400 hover:text-white transition-colors uppercase tracking-widest">Journal</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden pb-4 border-t border-white/5 mt-4 pt-4">
            <div className="flex flex-col gap-4">
              <a href="#story" className="text-sm font-medium text-white hover:text-red-500 transition-colors uppercase tracking-widest" onClick={() => setMobileMenuOpen(false)}>The Legend</a>
              ...
              <Link to="/#journal" className="text-sm font-medium text-stone-400 hover:text-white transition-colors uppercase tracking-widest" onClick={() => setMobileMenuOpen(false)}>Journal</Link>
